...
export async function getConnectionUsage(connection, { force = false } = {}) {
...
export async function GET(request, { params }) {
  ...
  try {
    ...
    try {
      return Response.json(await getConnectionUsage(connection, { force }));
    } catch (refreshError) {
      if (refreshError?.code === "CREDENTIAL_REFRESH_FAILED") {
